...
// Snapshot of the recipes that used to be hardcoded in RecipeDetails.jsx,
// reshaped into the Firestore "receitas" schema. Used only by
// migrarReceitasAntigas() in receitasService.js. Delete this file once the
// migration has been run and confirmed in the Firebase console.
export const receitasAntigas = [
    {
        slug: "torta-louca",
